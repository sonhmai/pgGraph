...
- Added a dependency update checker that reports Cargo, Python, and Docker
  update candidates without automatically applying them.
...
Docker updates are report-only and require manual changelog, digest, and
provenance review.
