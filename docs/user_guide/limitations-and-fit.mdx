...
| GQL | `graph.gql()` supports the documented read subset and single-node mapped `CREATE`; aggregates, path functions, multi-stage queries, and broader writes are future work |
