...
<p align="center">
  ...
  <a href="https://github.com/evokoa/pggraph/releases">
    <img src="https://img.shields.io/badge/version-0.1.6-2ea44f?style=flat-square" alt="Version 0.1.6">
  </a>
  <a href="LICENSE">
...
```bash
docker pull ghcr.io/evokoa/pggraph:0.1.6
docker run -d --rm \
  --name pggraph \
  -e POSTGRES_PASSWORD=postgres \
  -p 5432:5432 \
  ghcr.io/evokoa/pggraph:0.1.6
```
